...
### v1.4.0 (2025-04-16)
- ✨ 13の新しいミニゲームプラットフォームを追加（JD、Taobao、Discord、YouTube、Facebook、Google Play、vivo、OPPO、Xiaomi、Huawei、TikTok、CrazyGames、Poki）
- ✨ プラットフォーム総数を8から21に拡張、世界の主要なミニゲームプラットフォームをカバー
- 📚 すべての言語版のREADMEドキュメントを最新のプラットフォーム対応情報に更新
- 🐛 プラットフォーム定義シンボル管理を最適化し、相互排他メカニズムの安定性を向上
