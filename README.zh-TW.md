...
├── MiniGame/                      # 小遊戲平台適配 ⭐
│   ├── MiniGameDefineSymbolHelper.cs # 基礎宏定义管理
...
| **MiniGame** | 小遊戲適配 | 一鍵切換多平台小遊戲环境（8个平台） |
...
│   ├── Enable WeChat Mini Game (开启[微信小遊戲]適配)
│   ├── Enable Alipay Mini Game (开启[支付宝小遊戲]適配)
│   ├── Enable DouYin Mini Game (开启[抖音小遊戲]適配)
│   ├── Enable KuaiShou Mini Game (开启[快手小遊戲]適配)
│   ├── Enable Baidu Mini Game (开启[百度小遊戲]適配)
│   ├── Enable TapTap Mini Game (开启[TapTap小遊戲]適配)
│   ├── Enable Meituan Mini Game (开启[美团小遊戲]適配)
│   └── Enable Bilibili Mini Game (开启[Bilibili小遊戲]適配)
```
