...
namespace GameFrameX.Runtime
{
    ...
    public sealed class ZString
    {
        ...
        /// </summary>
        static Queue<ZString>[] g_cache;

        /// <summary>
        /// 次级缓存字典 - 存储超出核心缓存容量范围的字符串对象池
        /// Key为字符串长度，Value为对应长度的ZString队列
        /// </summary>
        static Dictionary<int, Queue<ZString>> g_secCache;

        /// <summary>
        /// 浅拷贝缓存栈 - 存储浅拷贝模式的ZString对象
        /// 浅拷贝直接引用原字符串，不进行内容复制，性能更高
        /// </summary>
        static Stack<ZString> g_shallowCache;
        ...
        private unsafe static ZString internal_format(string input, int num_args)
        {
            ...
            for (int i = -3;;)
            {
                ...
                ZString arg = g_format_args[argIdx];
                inputLength += arg.Length;
            }

            ZString result = get(inputLength);
        ...
        private unsafe static ZString internal_replace(string value, string oldValue, string newValue)
        {
        ...
        private unsafe static ZString internal_insert(string value, char toInsert, int start, int count)
        {
        ...
        public sealed class ZStringBlock : IDisposable
        {
            ...
            {
                _stack = new Stack<ZString>(capacity);
            }
        ...
        {
            g_cache = new Queue<ZString>[cacheCapacity];
            g_secCache = new Dictionary<int, Queue<ZString>>(cacheCapacity);
            ...
            g_shallowCache = new Stack<ZString>(shallowCacheCapacity);
        ...
        //子字符串替换
        public ZString Replace(string oldValue, string newValue)
        {
        ...
        /// <returns>格式化后的新ZString实例</returns>
        /// <exception cref="ArgumentNullException">当任意参数为null时抛出</exception>
        /// <seealso cref="Format(string, ZString, ZString, ZString, ZString, ZString, ZString, ZString, ZString, ZString, ZString)"/>
        ...
        /// </remarks>
        /// <seealso cref="ZString.StartsWith(string)"/>
        ...
        /// </remarks>
        /// <seealso cref="ZString.EndsWith(string)"/>
