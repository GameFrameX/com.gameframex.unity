...
namespace GameFrameX.Runtime
{
    ...
    public static class RandomUtility
    {
        ...
        /// <summary>
        /// 返回一个介于 0.0 和 1.0 之间的单精度随机数。
        /// </summary>
        /// <remarks>
        /// Returns a single-precision random number between 0.0 and 1.0.
        /// </remarks>
        /// <returns>返回一个大于等于 0.0 并且小于 1.0 的单精度浮点数 / A single-precision floating point number that is greater than or equal to 0.0 and less than 1.0</returns>
        [Preserve]
        public static float GetRandomFloat()
        {
            return (float)s_Random.Value.NextDouble();
        }
        ...
        /// </summary>
        /// <remarks>
        /// Returns a random number within the Int64 range.
        /// </remarks>
        /// <returns>返回一个随机的 Int64 值 / A random Int64 value</returns>
        [Preserve]
        ...
        /// </summary>
        /// <remarks>
        /// Returns a random number within the UInt64 range.
        /// </remarks>
        /// <returns>返回一个随机的 UInt64 值 / A random UInt64 value</returns>
        [Preserve]
