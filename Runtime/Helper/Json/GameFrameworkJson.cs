...
{
    public static partial class GameFrameworkJson
    {
        ...
        public static string ToJson(object obj)
        {
            ...
            catch (Exception exception)
            {
                ...
                throw new GameFrameworkException(GameFrameworkText.Format("Can not convert to JSON with exception '{0}'.", exception), exception);
            }
        }
        ...
        public static T ToObject<T>(string json)
        {
            ...
            catch (Exception exception)
            {
                ...
                throw new GameFrameworkException(GameFrameworkText.Format("Can not convert to object with exception '{0}'.", exception), exception);
            }
        }
