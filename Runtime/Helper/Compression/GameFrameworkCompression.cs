...
{
    public static partial class GameFrameworkCompression
    {
        ...
        public static bool Compress(byte[] bytes, int offset, int length, Stream compressedStream)
        {
            ...
            catch (Exception exception)
            {
                ...
                throw new GameFrameworkException(GameFrameworkText.Format("Can not compress with exception '{0}'.", exception), exception);
            }
        }
        ...
        public static bool Decompress(byte[] bytes, int offset, int length, Stream decompressedStream)
        {
            ...
            catch (Exception exception)
            {
                ...
                throw new GameFrameworkException(GameFrameworkText.Format("Can not decompress with exception '{0}'.", exception), exception);
            }
        }
