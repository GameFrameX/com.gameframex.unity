...
namespace GameFrameX.Tests
{
    ...
    public class UtilityHashHmacSha256Tests
    {
        ...
        {
            string result1 = HashUtility.HmacSha256.Hash("message", "key");
            string result2 = HashUtility.HmacSha256.Hash("message", "key");
        ...
        {
            string result1 = HashUtility.HmacSha256.Hash("message1", "key");
            string result2 = HashUtility.HmacSha256.Hash("message2", "key");
        ...
        {
            string result1 = HashUtility.HmacSha256.Hash("message", "key1");
            string result2 = HashUtility.HmacSha256.Hash("message", "key2");
            Assert.AreNotEqual(result1, result2);
        }
        ...
        {
            string result = HashUtility.HmacSha256.Hash("message", "key");
        ...
        {
            string result = HashUtility.HmacSha256.Hash("", "key");
            Assert.IsNotNull(result);
            Assert.Greater(result.Length, 0);
        }
        ...
        {
            string result = HashUtility.HmacSha256.Hash("message", "");
            Assert.IsNotNull(result);
            Assert.Greater(result.Length, 0);
        }
        ...
        {
            string result = HashUtility.HmacSha256.Hash("你好", "密钥");
            Assert.IsNotNull(result);
            Assert.Greater(result.Length, 0);
        }
        ...
        public void Hash_LongInput()
        {
            ...
            string result = HashUtility.HmacSha256.Hash(longMessage, longKey);
            Assert.IsNotNull(result);
        }
