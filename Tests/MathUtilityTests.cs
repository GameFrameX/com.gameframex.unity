...
namespace GameFrameX.Tests
{
    ...
    public class MathUtilityTests
    {
        ...
        public void CheckIntersect_RectInt_OverlappingRectangles_ReturnsTrue()
        {
            ...
            bool result = MathUtility.CheckIntersect(src, target);
        ...
        public void CheckIntersect_RectInt_IdenticalRectangles_ReturnsTrue()
        {
            ...
            bool result = MathUtility.CheckIntersect(rect, rect);
        ...
        public void CheckIntersect_RectInt_OneInsideOther_ReturnsTrue()
        {
            ...
            bool result = MathUtility.CheckIntersect(outer, inner);
        ...
        {
            bool result = MathUtility.CheckIntersect(0, 0, 10, 10, 5, 5, 10, 10);
        ...
        {
            bool result = MathUtility.CheckIntersect(0, 0, 10, 10, 0, 0, 10, 10);
        ...
        {
            bool result = MathUtility.CheckIntersect(0, 0, 10, 10, 20, 20, 10, 10);
        ...
        {
            bool result = MathUtility.CheckIntersect(0, 0, 10, 10, 10, 0, 10, 10);
        ...
        {
            bool result = MathUtility.CheckIntersect(0, 0, 10, 10, 0, 10, 10, 10);
        ...
        {
            bool result = MathUtility.CheckIntersect(0, 0, 0, 10, 0, 0, 10, 10);
        ...
        {
            bool result = MathUtility.CheckIntersect(0, 0, 10, 0, 0, 0, 10, 10);
        ...
        {
            bool result = MathUtility.CheckIntersect(0, 0, 10, 10, 8, 8, 10, 10);
        ...
        {
            bool result = MathUtility.CheckIntersect(0, 5, 20, 10, 8, 0, 5, 20);
        ...
        {
            bool result = MathUtility.CheckIntersect(0, 0, 10, 10, 10, 10, 5, 5);
        ...
        public void CheckIntersectPoints_NoOverlap_ReturnsFalse()
        {
            ...
            bool result = MathUtility.CheckIntersectPoints(0, 0, 10, 10, 20, 20, 10, 10, points);
        ...
        public void CheckIntersectPoints_Overlap_MarksIntersectionPoints()
        {
            ...
            bool result = MathUtility.CheckIntersectPoints(0, 0, 10, 10, 5, 5, 10, 10, points);
        ...
        public void CheckIntersectPoints_Overlap_PointsOutsideIntersectionRemainUnchanged()
        {
            ...
            MathUtility.CheckIntersectPoints(0, 0, 10, 10, 5, 5, 10, 10, points);
        ...
        public void CheckIntersectPoints_FullOverlap_ClearsAllMarkedPoints()
        {
            ...
            MathUtility.CheckIntersectPoints(0, 0, 10, 10, 0, 0, 10, 10, points);
